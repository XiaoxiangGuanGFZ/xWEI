...
df_rr = pd.read_csv(
    # df for daily rainfall (E-OBS 0.5deg)
    ws + '/E-OBS_obs_daily_rr.csv',
    header=None, sep=','
)
...
fp_xwei = ws + 'xWEI/output/EOBS_xWEI.csv'
for fid in FIDs:
    ...
    ri_data_domain = df_rr.iloc[:, Box_id_domain.EOBS_ID + 2]
